...
<div class="team-nav my-5 w-100">
  <select onchange="if (this.value) window.location.href=this.value" class="w-100 p-2">
    ...
    <option value="#ats-team">ATS Team</option>
    <option value="#collections-team">Collections Team</option>
    <option value="#digital-collections-team">Digital Collections Team</option>
    <option value="#discovery-team">Discovery Team</option>
    <option value="#first-year-experience-team">First Year Experience Team</option>
    <option value="#instruction-team">Instruction Team</option>
    <option value="#liaisons-team">Liaisons Team</option>
    <option value="#library-website-team">Library Website Team</option>
    <option value="#marcom-team">MarCom Team</option>
    <option value="#mentorship-scholarship-team">Mentorship/Scholarship Team</option>
    <option value="#open-engagement-team">Open Engagement Team</option>
    <option value="#physical-spaces-and-public-programming-team">Physical Spaces and Public Programming Team</option>
    <option value="#research-impact-team">Research Impact Team</option>
    <option value="#sed-team">SED Team</option>
    <option value="#student-engagement-team">Student Engagement Team</option>
  </select>
</div>
