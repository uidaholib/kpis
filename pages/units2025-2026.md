...
<div class="team-nav my-5 w-100">
  <select onchange="if (this.value) window.location.href=this.value" class="w-100 p-2">
    ...
    <option value="#access-engagement-unit">Access & Engagement Unit</option>
    <option value="#discovery-acquisitions-unit">Discovery & Acquisitions Unit</option>
    <option value="#digital-scholarship-and-open-strategies-unit">Digital Scholarship and Open Strategies Unit</option>
    <option value="#research-experiential-learning-unit">Research & Experiential Learning Unit</option>
    <option value="#special-collections-and-archives">Special Collections and Archives</option>
  </select>
</div>
